<script>
	...
	document.write("Distância pecorrida com Gasolina é: " + caminhoComGasolina / 40 + "km por litro" );
	document.write("<br>");

	var caminhoComAlcool = 300;
	document.write("Distância pecorrida com Álcool é: " + caminhoComAlcool / 40 + "km por litro" );
